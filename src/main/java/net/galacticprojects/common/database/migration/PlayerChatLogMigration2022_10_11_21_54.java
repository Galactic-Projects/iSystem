...
public class PlayerChatLogMigration2022_10_11_21_54 extends MySQLMigration {
    ...
    public String getNewFormat() {
        return "ID INT AUTO_INCREMENT, UUID VARCHAR(36) NOT NULL, NAME VARCHAR(32) NOT NULL, IP VARCHAR(24) NOT NULL, SERVER VARCHAR(128) NOT NULL, TIMESTAMP VARCHAR(128) NOT NULL, MESSAGE LONGTEXT, PRIMARY KEY (ID)";
    }
