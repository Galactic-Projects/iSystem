...
public class BanMigration2022_10_11_21_48 extends MySQLMigration {
    ...
    public String getNewFormat() {
        return "ID INT AUTO_INCREMENT, UUID VARCHAR(36) NOT NULL, STAFF VARCHAR(64), BANID VARCHAR(64), REASON VARCHAR(128) NOT NULL, TIME VARCHAR(128), CREATIONTIME VARCHAR(128) NOT NULL, PRIMARY KEY (ID)";
    }
