...
public class PlayerDataMigration2022_10_11_21_52 extends MySQLMigration {
    ...
    public String getNewFormat() {
        return "ID INT AUTO_INCREMENT, UUID VARCHAR(36), IP VARCHAR(24) NOT NULL, COINS VARCHAR(64) DEFAULT '0', LEVEL VARCHAR(64) DEFAULT '0', LANGUAGE VARCHAR(12), ONLINETIME LONGTEXT, PRIMARY KEY (ID)";
    }
