...
public class PlayerDataMigration2022_10_11_21_52 extends MySQLMigration {
    ...
    public String getNewFormat() {
        return "ID INT AUTO_INCREMENT, UUID VARCHAR(36), IP VARCHAR(21) NOT NULL, COINS BIGINT DEFAULT 0, LEVEL INT DEFAULT 0, LANGUAGE VARCHAR(10), ONLINETIME LONG DEFAULT 0, PRIMARY KEY (ID)";
    }
