package net.galacticprojects.utils.color;

import com.syntaxphoenix.syntaxapi.utils.java.lang.StringBuilder;
import net.galacticprojects.utils.color.helper.ColorIterator;
import net.galacticprojects.utils.color.helper.LinearGradient;
